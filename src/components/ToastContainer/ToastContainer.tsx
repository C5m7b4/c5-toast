    ...
    if (autoClose) {
      setTimeout(() => {
        ...
        if (toast) {
          ...
          if (toastDiv) {
            toastDiv.classList.remove(`${Default.CSS_NAMESPACE}__slide-in`);
            toastDiv.classList.add(`${Default.CSS_NAMESPACE}__slide-out`);
            toastDiv.style.animation = `${Default.CSS_NAMESPACE}__slide-out 1s ease forwards`;
